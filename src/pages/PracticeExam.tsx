...
export default function PracticeExam() {
  ...
  const generateExam = async () => {
    ...
    try {
      const { data, error: fnError } = await supabase.functions.invoke('generate-practice-exam', {
      ...
      <div className="min-h-screen bg-background">
        <header className="border-b">
          <div className="container mx-auto px-4 py-4 flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">Practice Final Exam</h1>
          </div>
        </header>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">Reichman Mechina Practice Exam</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="text-muted-foreground space-y-2">
                  <p>Generate a full practice exam matching the 2021 final exam format:</p>
                  <ul className="text-sm space-y-1">
                    <li>• 5 questions totaling 100 points</li>
                    <li>• Multi-part questions (a, b, c, d)</li>
                    <li>• 3 hour time limit</li>
                    <li>• Includes parabolas, exponentials, derivatives & more</li>
                  </ul>
                </div>
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Creating 5 questions in Reichman format...</p>
          </div>
        </div>
      </div>
    );
      ...
      <AlertDialog open={showSubmitDialog} onOpenChange={setShowSubmitDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to submit your exam? You will be able to see the solutions after submitting.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
